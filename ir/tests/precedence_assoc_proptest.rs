...
proptest! {
    ...
    #[test]
    fn precedence_postcard_roundtrip(p in arb_precedence()) {
    ...
    #[test]
    fn associativity_postcard_roundtrip(a in arb_associativity()) {
    ...
    #[test]
    fn prec_kind_postcard_roundtrip(pk in arb_precedence_kind()) {
