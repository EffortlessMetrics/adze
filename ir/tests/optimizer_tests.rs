...
fn test_optimize_with_precedence() {
    ...
    grammar.add_rule(Rule {
        lhs: SymbolId(0),
        rhs: vec![Symbol::NonTerminal(SymbolId(0)), Symbol::Terminal(SymbolId(1)), Symbol::NonTerminal(SymbolId(0))],
    ...
    grammar.add_rule(Rule {
        lhs: SymbolId(0),
        rhs: vec![Symbol::NonTerminal(SymbolId(0)), Symbol::Terminal(SymbolId(2)), Symbol::NonTerminal(SymbolId(0))],
