...
fn assert_binary_roundtrip(grammar: &Grammar, test_name: &str) {
...
#[test]
fn test_grammar_default_postcard_roundtrip() {
    let grammar = Grammar::new("default".to_string());
    assert_binary_roundtrip(&grammar, "grammar_default");
}
...
#[test]
fn test_grammar_with_rules_postcard_roundtrip() {
    let mut grammar = Grammar::new("with_rules".to_string());
    ...
    assert_binary_roundtrip(&grammar, "grammar_with_rules");
}
...
#[test]
fn test_symbol_epsilon_postcard_roundtrip() {
    let symbol = Symbol::Epsilon;
...
#[test]
fn test_external_token_postcard_roundtrip() {
    let external = ExternalToken {
        name: "DEDENT".to_string(),
...
#[test]
fn test_symbol_id_postcard_roundtrip() {
...
#[test]
fn test_grammar_large_rules_postcard_roundtrip() {
    let mut grammar = Grammar::new("large_rules".to_string());
    ...
    assert_binary_roundtrip(&grammar, "grammar_large_rules");
}
...
#[test]
fn test_precedence_kind_static_postcard_roundtrip() {
...
#[test]
fn test_precedence_kind_dynamic_postcard_roundtrip() {
...
#[test]
fn test_associativity_all_variants_postcard_roundtrip() {
    let variants = vec![
        Associativity::Left,
        Associativity::Right,
        Associativity::None,
...
#[test]
fn test_grammar_with_many_rules_postcard_roundtrip() {
    let mut grammar = Grammar::new("many_rules_postcard".to_string());
    ...
    assert_binary_roundtrip(&grammar, "many_rules_postcard");
}

#[test]
fn test_all_symbol_types_postcard_roundtrip() {
    let symbols = vec![
        Symbol::Terminal(SymbolId(1)),
        Symbol::NonTerminal(SymbolId(2)),
...
#[test]
fn test_state_id_postcard_roundtrip() {
    let id = StateId(1024);
    let bytes = postcard::to_stdvec(&id).expect("serialize");
...
#[test]
fn test_grammar_builder_postcard_roundtrip() {
    let grammar = GrammarBuilder::new("postcard_builder")
        .token("NUMBER", r"\d+")
        .token("+", "+")
        .rule("expr", vec!["expr", "+", "expr"])
        .rule("expr", vec!["NUMBER"])
    ...
    assert_binary_roundtrip(&grammar, "grammar_builder_postcard");
}
