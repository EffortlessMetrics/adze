...
fn grammar_name_strategy() -> impl Strategy<Value = String> {
    "[a-z]{3,8}".prop_filter("must not be a Rust keyword", |s| {
        !matches!(
            s.as_str(),
            "gen" | "do" | "abstract" | "become" | "final" | "override"
                | "priv" | "typeof" | "unsized" | "virtual"
                | "box" | "macro" | "try" | "yield"
                | "fn" | "let" | "mut" | "ref" | "pub" | "mod"
                | "use" | "for" | "if" | "else" | "loop" | "while"
                | "match" | "impl" | "enum" | "struct" | "trait"
                | "type" | "where" | "async" | "await" | "dyn"
                | "move" | "return" | "break" | "continue" | "const"
                | "static" | "extern" | "crate" | "self" | "super" | "as" | "in"
        )
    })
}
