use crate::{GLRError, Grammar, GrammarError, ProductionId, Rule, Symbol, SymbolId};

pub(crate) struct AugmentedGrammar {
    pub(crate) grammar: Grammar,
    pub(crate) original_start: SymbolId,
    pub(crate) augmented_start: SymbolId,
}

pub(crate) fn build(grammar: &Grammar, max_symbol: u16) -> Result<AugmentedGrammar, GLRError> {
