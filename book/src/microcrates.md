...
| `feature-profile-metadata` | `crates/feature-profile-metadata/` | Parser feature-profile snapshot metadata |
| `governance-metadata` | `crates/governance-metadata/` | Governance progress/status metadata |
