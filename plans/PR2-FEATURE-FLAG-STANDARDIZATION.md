...
| Crate | Features |
|-------|----------|
| `adze-runtime-governance-matrix` | `pure-rust`, `tree-sitter-standard`, `tree-sitter-c2rust`, `glr`, `strict_api`, `strict_docs` |
...
- [`runtime/Cargo.toml:39`](runtime/Cargo.toml:39): `glr = ["adze-runtime-governance-matrix/glr"]`
