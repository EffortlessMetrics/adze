...
- 🟡 **Remaining hardening**: Windows pure-Rust benchmark-tail follow-up ([#269](https://github.com/EffortlessMetrics/adze/issues/269)) and publishability checklist execution.
