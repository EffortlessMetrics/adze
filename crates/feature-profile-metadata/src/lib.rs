//! Snapshot metadata for parser feature profiles.
//!
//! This crate owns serde-ready feature profile snapshots used in generated
//! artifacts and diagnostics payloads.
