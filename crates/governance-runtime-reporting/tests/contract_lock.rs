...
//!
//! This crate provides shared runtime report formatting for governance snapshots.
...
fn test_contract_lock_functions() {
    ...
    assert!(total > 0 || total == 0); // Always valid
    ...
    assert_eq!(_snapshot.phase, BddPhase::Core);
}

/// Verify bdd_progress_report_with_profile_runtime function (the main addition in this crate).
#[test]
fn test_contract_lock_runtime_report_function() {
