...
//!
//! This crate composes focused microcrates for profile selection and reporting
//! so both `runtime` and `runtime2` consumers can share the same behavior and
//! fixture wiring for BDD progress reporting.
