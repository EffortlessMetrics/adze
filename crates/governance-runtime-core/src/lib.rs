...
//!
//! This crate composes runtime profile helpers with governance reporting so that
//! `runtime` and `runtime2` consumers can share fixture wiring and status output.
...
pub use adze_runtime_profile_core::{
