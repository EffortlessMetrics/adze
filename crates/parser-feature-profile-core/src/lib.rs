//! Core parser feature-profile contracts.
//!
//! This crate intentionally owns only parser feature profile semantics so policy
//! and governance crates can share behavior without inheriting extra dependencies.
