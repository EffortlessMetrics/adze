//! Reporting helpers for BDD governance snapshots and parser feature diagnostics.
//!
//! This crate isolates output formatting from governance state calculations so
//! matrix composition and textual rendering can evolve independently.
