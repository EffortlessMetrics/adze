//! Parser feature profile snapshot metadata for governance artifacts.
//!
//! This microcrate isolates parser feature snapshot concerns so other governance
//! metadata crates can remain focused on scenario progress and reporting.
