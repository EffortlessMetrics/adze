...
//! Shared constants and utilities for Tree-sitter table format encoding.
//! This keeps encoding choices isolated in a single-responsibility microcrate.

use adze_glr_core::{Action, ParseTable};

/// Tree-sitter action type tags.
///
/// These values must match Tree-sitter's internal constants exactly.
#[repr(u8)]
