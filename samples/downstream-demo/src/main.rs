...
fn main() {
    ...
    println!("✓ Parse table built with {} states", parse_table.state_count);
    ...
    println!("\n=== Compression Results ===");
    println!("Action table compressed size: {} bytes", compressed.action_table.data.len());
    println!("Goto table compressed size: {} bytes", compressed.goto_table.data.len());
    println!("Small table threshold: {}", compressed.small_table_threshold);
