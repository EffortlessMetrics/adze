...
use crate::pure_parser::{Parser as PureParser, ParseResult, TSLanguage};
use crate::pure_incremental::{Edit, Tree, IncrementalParser};
...
impl Parser {
    ...
    pub fn parse_with_edits(
        ...
        self.incremental_parser.parse_with_edits(source, old_tree, edits)
    }
