...
mod ambiguous_incremental_tests {
    ...
    fn test_dangling_else_ambiguity_preserved() {
        ...
        assert_eq!(old_forest.alternatives.len(), 1, 
        ...
        println!("Number of parse alternatives: {}", new_forest.alternatives.len());
    ...
    fn test_ambiguous_expression_with_reuse() {
        ...
        println!("Number of parse alternatives for '1-2-3': {}", old_forest.alternatives.len());
        ...
        println!("Number of parse alternatives after edit: {}", new_forest.alternatives.len());
    ...
    fn test_ambiguity_destroyed_by_edit() {
        ...
        println!("Initial parse alternatives: {}", old_forest.alternatives.len());
        ...
        println!("Parse alternatives after edit: {}", new_forest.alternatives.len());
        
        if old_forest.alternatives.len() > 1 && new_forest.alternatives.len() == 1 {
            println!("✅ Successfully reduced ambiguity from {} to {} alternative(s)", 
                old_forest.alternatives.len(), new_forest.alternatives.len());
        } else {
            println!("ℹ️ Ambiguity change: {} → {} alternatives", 
                old_forest.alternatives.len(), new_forest.alternatives.len());
        }
    }
}