...
fn test_column_calculation() {
    ...
    let test_cases = vec![
        TestCase { position: 0, expected_column: 0, description: "Start of file" },
        TestCase { position: 2, expected_column: 2, description: "Middle of first line" },
        TestCase { position: 3, expected_column: 3, description: "Before LF" },
        TestCase { position: 4, expected_column: 0, description: "After LF" },
        TestCase { position: 7, expected_column: 3, description: "Before CR in CRLF" },
        TestCase { position: 9, expected_column: 0, description: "After CRLF" },
        TestCase { position: 12, expected_column: 3, description: "Before lone CR" },
        TestCase { position: 13, expected_column: 0, description: "After lone CR" },
    ];
