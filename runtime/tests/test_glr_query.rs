...
fn parse_expression(_grammar: &Grammar, input: &str) -> Option<Subtree> {
    ...
    if input == "1 + 2" {
        ...
        // Create tree for "1 + 2 + 3" -> ((1 + 2) + 3)
        Some(Subtree {
            symbol: add_expr_id,
            children: vec![
                // Left: (1 + 2) as add_expression
                Subtree {
                    symbol: add_expr_id,
                    children: vec![
                        Subtree {
        ...
        Some(Subtree {
            symbol: mul_expr_id,
            children: vec![
                // Left: (1 + 2) as paren_expression containing add_expression
                Subtree {
        ...
        Some(Subtree {
            symbol: add_expr_id,
            children: vec![
                // Left: ((1 + 2) * 3) as expression -> term -> factor (paren_expression)
                Subtree {
                    symbol: expr_id,
                    children: vec![Subtree {
                        symbol: term_id,
...
fn test_query_parser_errors() {
    ...
    let test_cases = vec![
        ...
        ("(#unknown?)", "ExpectedIdentifier"), // Predicates can't appear standalone
