...
mod incremental_properties {
    ...
    fn create_edit(pos: usize, del_len: usize, insert_len: usize) -> Edit {
        Edit {
            ...
            start_point: Point { row: 0, column: pos }, // Simplified - assumes single line
            old_end_point: Point { row: 0, column: pos + del_len },
            new_end_point: Point { row: 0, column: pos + insert_len },
        }
    }
