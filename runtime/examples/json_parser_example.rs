...
fn build_json_grammar() -> Grammar {
    ...
    let prod_id = alloc_production();
    grammar.rules.insert(SymbolId(next_symbol_id), Rule {
        lhs: value_id,
    ...
    let prod_id = alloc_production();
    grammar.rules.insert(members_id, Rule {
        lhs: members_id,
    ...
    let prod_id = alloc_production();
    grammar.rules.insert(member_id, Rule {
        lhs: member_id,
        rhs: vec![
    ...
    let prod_id = alloc_production();
    grammar.rules.insert(elements_id, Rule {
        lhs: elements_id,
...
fn main() {
    ...
    let grammar = Arc::new(build_json_grammar());
