...
fn benchmark_incremental_parsing(c: &mut Criterion) {
    ...
    for size in [10, 50, 100].iter() {
        ...
        let edit = Edit {
            ...
            start_position: Position { line: 0, column: (edit_pos * 2) as usize },
            old_end_position: Position { line: 0, column: (edit_pos * 2 + 1) as usize },
            new_end_position: Position { line: 0, column: (edit_pos * 2) as usize },
        };
