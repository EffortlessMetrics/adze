...
- [ ] `count_conflicts()` detects all multi-action cells
- [ ] Conflict classification is accurate
- [ ] Helper functions work correctly
- [ ] Display implementations are readable
- [ ] Unit tests pass (100% coverage)
- [ ] Integration tests pass for ambiguous grammars
