...
`adze` has three verification surfaces:
...
Pull requests run advisory `ripr` evidence and review guidance. Targeted mutation remains a separate routed check when labels, release risk, impacted evidence, or severe `ripr` gaps require it.
