# Rust Sitter API Reference

> **v0.5.0-beta:** This is a beta release. The API is subject to change.

This document provides a reference for the core APIs of Rust Sitter.
