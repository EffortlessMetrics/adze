...
impl<'a> LanguageValidator<'a> {
    ...
    #[expect(clippy::ptr_arg, reason = "parameter type is part of the validate_table_dimensions contract shared across implementations; changing to a slice would break the interface")]
