...
mod tests {
    ...
    fn test_language_version() {
        ...
        #[expect(clippy::assertions_on_constants, reason = "compile-time assertion documents the ABI version contract; the constant check is intentional and serves as a regression guard")]
        const _: () =
